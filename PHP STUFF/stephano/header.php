...
<body>
    ...
    <div class="big-title" style="<?php if($_SERVER['PHP_SELF'] =="/index.php")echo 'display:none;' ?>">
        <span class="title">
            <?php
                echo strtoupper( trim(trim($_SERVER['PHP_SELF'],".php"),"/"));
            ?>
        </span>
    </div>
    <!-- END NAVBAR -->
                    ...
                    <div class="herbalife-info"><a class="herbalife-close" href="#" onclick="wcHidePopUp()">x</a>
                        ...
                        <div class="herbalife-row">
                            ...
                            <div class="two-third border">
                                <p>Scopri i benefici di ricevere l’assistenza da parte di Membro Indipendente Herbalife.</p>
                        ...
                        <div class="herbalife-row">
                            <div class="two-third">
                                <p class="copy">I prodotti Herbalife sono venduti esclusivamente attraverso i nostri Membri
