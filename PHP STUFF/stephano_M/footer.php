        ...
        <div class="row text-center text-xs-center text-sm-left text-md-left">
            <div class="col-xs-12 col-sm-4 col-md-4">
                ...
                <ul class="list-unstyled quick-links">
                    ...
                    <li><a href="<?php if($pageName=='index'){echo '#Prodotto';}else{ echo 'index#Prodotto';}?>"><i
                                class="fa fa-angle-double-right"></i>Productto</a></li>
            ...
            <div class="col-xs-12 col-sm-4 col-md-4">
                <h5>CONTACT</h5>
                <ul class="list-unstyled quick-links">
                    <li><a href="<?php if($pageName=='index' ){echo '#ContactUs' ;}else{ echo 'index#ContactUs';}?>"><i
                                class="fa fa-angle-double-right"></i>CONTATTO SULLA</a></li>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-5">
                <ul class="list-unstyled list-inline social text-center">
                    <li class="list-inline-item"><a href="https://www.facebook.com/w24fitclub/"><i class="fa fa-facebook"></i></a></li>
                    <li class="list-inline-item"><a href="https://www.instagram.com/stebarberini"><i class="fa fa-instagram"></i></a></li>
                </ul>
            </div>
        </div>
        <hr class="my-4">
